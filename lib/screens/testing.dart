...
class UpdateEvents extends StatefulWidget {
  final editname, editdate, editdescription, documnetId;
  final editimagesList;
  UpdateEvents(
      {this.editname,
      this.editdate,
...
class _UpdateEventsState extends State<UpdateEvents> {
  ...
  @override
  void initState() {
    name.text = widget.editname;
    date.text = widget.editdate;
    description.text = widget.editdescription;
    imagesList = widget.editimagesList;
    super.initState();
  }
